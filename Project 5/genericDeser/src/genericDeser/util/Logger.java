...
/**
 * Logger Class This class is responsible for logging message based off passed
 * debug level
 * 
 * @author PRASHANT
 *
...
public class Logger {
	...
	public static enum DebugLevel {
		CONSTRUCTOR, ExtractObject, ProcessCollection, NO_OUTPUT
	};
	...
	public static void setDebugValue(int levelIn) {
		...
		case 3:
			...
			break;
		case 2:
			debugLevel = DebugLevel.ExtractObject;
			break;
		case 1:
			debugLevel = DebugLevel.ProcessCollection;
			break;
		case 0:
