...
/**
 * Class - FileProcessor This class is used for all File I/O
 * 
 * @author PRASHANT
 *
 */
public class FileProcessor {
	...
	public void writeToFile(String output) {
		try {
			...
			System.err.println(" Exception Occured  Method File Processor -> WriteTofile - \n");
			e.printStackTrace();
			System.exit(0);
		} finally {
			// closing file writer where write to file is clalled
		}
	}
}
